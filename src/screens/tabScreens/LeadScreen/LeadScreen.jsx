  ...
  return (
    <div className="flex h-screen bg-black">
      ...
      {selectedTab === 'Information' && (
        <div className="bg-white mt-5 rounded-lg space-x-5 py-1 ml-7 h-full pb-7">
      ...
      {selectedTab === 'Files' && <div className="flex h-full"><div className="flex-grow w-2/3 flex-shrink-0 space-x-6  h-full mt-4 "> <FilesTab /></div></div>}
      {selectedTab === 'Tag people' && (
        <div className="flex h-full"><div className="flex-grow w-2/3 flex-shrink-0 space-x-6  h-full mt-4 ">
      ...
      {selectedTab === 'Request' && (
       ...
       <div className="absolute bottom-7 right-14 flex space-x-4">
